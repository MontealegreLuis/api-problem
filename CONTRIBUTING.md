# Contributing to API Problem

## Code of Conduct

This project is released with a [Contributor Code of Conduct](https://github.com/MontealegreLuis/api-problem/blob/main/CODE-OF-CONDUCT.md).
...
## Using API Problem from a Git checkout

The following commands can be used to perform the initial checkout of API Problem:

```bash
git clone git://github.com/MontealegreLuis/api-problem.git
cd api-problem
```
...
Before opening a new ticket, please search through the [existing issues](https://github.com/MontealegreLuis/api-problem/issues).
